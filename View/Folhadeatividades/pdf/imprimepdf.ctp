...
<p style="font-size: 90%">DRE: <?= $estagio['Estagiario']['registro'] ?>
    Telefone: <?= $estudante['Alunonovo']['celular'] ?>
    E-mail: <?= $estudante['Alunonovo']['email'] ?>
</p>
...
<div>
    ...
    <table class="table" style="width: 100%; background-color: white;">
        <tr>
            ...
            <td><span style="font-size: 100%; text-decoration: overline"><?= $estagio["Estagiario"]["Alunonovo"]["nome"] ?></span></td>
            <td><span style="font-size: 100%; text-decoration: overline"><?= $estagio['Estagiario']['Supervisor']['nome'] ?></span></td>
        </tr>

        <tr>
            <td></td>
            <td><span style="font-size: 100%">DRE: <?= $estagio["Estagiario"]["Alunonovo"]["registro"] ?></span></td>
