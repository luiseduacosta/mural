...
*/
    ...
    public function imprimepdf($id = null) {
        ...
        // $options = array('conditions' => array('Folhadeatividade.' . $this->Folhadeatividade->primaryKey => $id));
        $options = ['conditions' => ['Folhadeatividade.estagiario_id' => $estagiario_id], 'order' => 'dia'];
        ...
        /* Para pegar o nome e o id do estagiario */
        $this->loadModel('Alunonovo');
        $this->set('estudante', $this->Alunonovo->find('first', ['conditions' => ['Alunonovo.id' => $folhadeatividade['Estagiario']['alunonovo_id']]]));
        // $this->Folhadeatividade->contain(['Estagiario' => ['Alunonovo', 'Supervisor', 'Instituicao', 'Professor', 'Supervisor']]);
        $this->Folhadeatividade->recursive = 2;        
    ...
    public function add($id = NULL) {
        ...
        if ($this->request->is('post')) {
            pr($this->request->data);
            $interval = date_diff($this->request->data['Folhadeatividade']['inicio'],$this->request->data['Folhadeatividade']['final']);
            echo $interval;
            die();
