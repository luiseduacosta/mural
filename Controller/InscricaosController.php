...
class InscricaosController extends AppController {
    ...
    public function add($id = null) {
        ...
        if ($this->data) {
            ...
            /* Verificacoes */
            if ((strlen(trim($this->request->data['Inscricao']['id_aluno']))) < 9) {
    ...
    /* Captura o registro digitado pelo estudante e envia para a funcao termocompromiso() */
    ...
    /* Com o numero de registro busca as informacoes para preencher o formulário */
    public function termocompromisso($id = null) {
        ...
        $estagiario = $this->Inscricao->Estagiario->find(
                ...
                [
                    ...
                    'fields' => ['Estagiario.id', 'Estagiario.periodo', 'Estagiario.turno', 'Estagiario.complemento_id', 'Estagiario.id_aluno', 'Estagiario.alunonovo_id', 'Estagiario.registro', 'Estagiario.nivel', 'Estagiario.id_instituicao', 'Estagiario.id_supervisor', 'Estagiario.id_professor', 'Estagiario.ajuste2020', 'Aluno.id', 'Aluno.registro', 'Alunonovo.id', 'Alunonovo.registro', 'Alunonovo.nome', 'Alunonovo.ingresso', 'Alunonovo.turno'],
        ...
        if (empty($estagiario)) {
            ...
            // pr($alunonovo);
            // die('alunonovo');
            /* Aluno novo cadastrado: copia todos os dados do alunonovo para a tabela aluno excluindo o id. */
            if ($alunonovo) {
                ...
                if (empty($aluno)) {
                    ...
                    // pr($alunonovo);
                    // die('alunonovo');
                    $this->Aluno->set($alunonovo['Alunonovo']);
    ...
    public function termocadastra($id = null) {
        ...
        if ($this->data) {
            ...
            if (empty($aluno)) {
                ...
                $alunonovo['Alunonovo']['id'] = $this->data['Estagiario']['alunonovo_id'];
                // pr($alunonovo);
                // die();
                ...
                if ($aluno['Aluno']['id']) {
                    ...
                    $this->Flash->error(__("Não foi possível atualizar o registro do Aluno"));
                    exit();
                }
    ...
    function imprimepdf($id = null) {
        ...
        $this->set('inicio', $termoinicio);
        $this->set('final', $termofinal);
    }
